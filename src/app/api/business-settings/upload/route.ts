// ================================================================
// api/business-settings/upload/route.ts
// Sube archivos de branding (logo, banner, favicon) a Supabase Storage.
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Update tenant record with the new URL
    const { prisma } = await import("@/lib/prisma");
    const updateField: Record<string, string> = {};
    if (type === "logo") updateField.logoUrl = publicUrl;
    if (type === "banner") updateField.bannerUrl = publicUrl;
    if (type === "favicon") updateField.faviconUrl = publicUrl;
